...
from .models import Contract, Category, Questionnaire, Question, CustomSettings, GeneralSettings, ContractFile, ContractFileSettings
...
class ContractFileSettingsAdmin(admin.ModelAdmin):
    list_display = ('contract_file', 'contract_file')
admin.site.register(ContractFileSettings, ContractFileSettingsAdmin)

class CategoryAdmin(admin.ModelAdmin):
    list_display = ('name', 'creator_company')
